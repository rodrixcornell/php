...
&& apt-get install -yq --no-install-recommends php$PHP_VERSION-{bcmath,cli,curl,gd,json,mbstring,mcrypt,mysql,sqlite*,xml,zip} libaio1 curl alien make php$PHP_VERSION-dev \
\

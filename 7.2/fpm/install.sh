...
&& apt-get install -yq --no-install-recommends php$PHP_VERSION-{bcmath,curl,fpm,gd,json,mbstring,mysql,sqlite*,xml,zip} libaio1 curl alien make php$PHP_VERSION-dev \
\
